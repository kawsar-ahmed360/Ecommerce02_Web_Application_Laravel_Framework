...
<div class="modal fade" id="EditeSize" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" style="z-index: 9999999">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" id="myModalLabel">Size Edite</h4>
            </div>
            <div class="modal-body">


                <form action="{{ route('Sizes_Editeajax') }}" method="POST" id="Size_Edite" accept-charset="utf-8">
                    @csrf
